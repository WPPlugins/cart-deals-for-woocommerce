 ...
 // add items to the Cart Deals custom post type menu structure
  ...
  if ( (isset( $vtcrt_setup_options['register_under_tools_menu'] ))  && 
	...
	add_submenu_page(
		...
		__( 'Cart Deal Settings', 'vtcrt' ), // The value used to populate the browser's title bar when the menu page is active                           
		__( 'Cart Deal Settings', 'vtcrt' ),					// The label of this submenu item displayed in the menu
...
function vtcrt_set_default_options() {
      /*
      //v1.0.3 changed to always be YES!!
      if(defined('VTCRT_PRO_DIRNAME')) { 
     ...
     $options = array(           
          ...
          'use_lifetime_max_limits' => 'yes',    //opt2   //v1.0.3 changed to always be YES, as we always check for PRO anyway when using the switch
...
function vtcrt_validate_setup_input( $input ) {
  ...
  switch( true ) { 
    ...
    default:   //standard update button hit...                 
        $output = get_option( 'vtcrt_setup_options' ); //v1.0.3  changed from array initialize
