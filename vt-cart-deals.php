...
class VTCRT_Controller{
    ...
    if(!isset($_SESSION)){
      ...
      header("Pragma: no-cache");
		...
		define('VTCRT_VERSION',                               '1.0.5');
    define('VTCRT_MINIMUM_PRO_VERSION',                   '1.0.5');
    define('VTCRT_LAST_UPDATE_DATE',                      '2017-04-03');
    ...
    /*  =============+++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */    
    if (is_admin()) {   //v1.0.3   only add during is_admin
 ...
 *************************************************** */
    ...
    **********************************  */
    ...
    if (is_admin()){ 
        ...
        //v1.0.3 begin
        if ( (defined('VTCRT_PRO_DIRNAME')) &&
             (version_compare(VTCRT_PRO_VERSION, VTCRT_MINIMUM_PRO_VERSION) < 0) ) {    //'<0' = 1st value is lower  
  ...
  ***************************************************/ 
  function vtcrt_custom_bulk_actions($actions){
              ...
              //v1.0.3  add  ".inline.hide-if-no-js, .view" to display:none; list
    ?>         
  ...
  */  
	public function vtcrt_admin_init(){
      /*
      //v1.0.5 removed - causes warning on install/delete    
  ...
  *************************************************** */  
  ...
  //v1.0.3 begin
   public function vtcrt_admin_notice_version_mismatch() {
      $message  =  '<strong>' . __('Please also update plugin: ' , 'vtcrt') . ' &nbsp;&nbsp;'  .VTCRT_PRO_PLUGIN_NAME . '</strong>' ;
      $message .=  '<br>&nbsp;&nbsp;&bull;&nbsp;&nbsp;' . __('Your Pro Version = ' , 'vtcrt') .VTCRT_PRO_VERSION. ' &nbsp;&nbsp;' . __(' The Minimum Required Pro Version = ' , 'vtcrt') .VTCRT_MINIMUM_PRO_VERSION ;      
      $message .=  '<br>&nbsp;&nbsp;&bull;&nbsp;&nbsp;' . __('Please delete the old Pro plugin from your installation via ftp.'  , 'vtcrt');
      $message .=  '<br>&nbsp;&nbsp;&bull;&nbsp;&nbsp;' . __('Go to ', 'vtcrt');
      $message .=  '<a target="_blank" href="http://www.varktech.com/download-pro-plugins/">Varktech Downloads</a>';
      $message .=   __(', download and install the newest <strong>'  , 'vtcrt') .VTCRT_PRO_PLUGIN_NAME. '</strong>' ;
